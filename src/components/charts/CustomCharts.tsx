...
export const LineChart: React.FC<LineChartProps> = ({ data }) => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between gap-2">
      ...
      {/* Legend */}
      <div className="flex justify-center gap-6 mt-1 text-xs font-semibold text-slate-600">
